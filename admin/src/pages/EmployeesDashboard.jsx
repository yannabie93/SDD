  ...
  return (
    <Box sx={{display:'flex', height:'100%'}}>
      ...
      <Box sx={{display:'flex', flex:6, flexDirection:'column'}}>
        ...
        <Box  sx={{display:'flex', flex:2, flexWrap:'wrap', p:4, gap:4, alignItems:'center', justifyContent:'center' , flexDirection:'column', width: '100%'}}>
          ...
          <Box ref={componentRefs.allData}>
            ...
            {/* AGE */}
            <Box ref={componentRefs.ageData}  sx={{ gap:2,display:'flex', flexDirection:'column', height: '600px', width: '100%', boxShadow:3, justifyContent:'center', alignItems:'center'}}>
            ...
            <Box ref={componentRefs.genderData} sx={{gap:2, display:'flex', flexDirection:'column', height: '600px', width: '100%', boxShadow:3, justifyContent:'center', alignItems:'center'}}>
